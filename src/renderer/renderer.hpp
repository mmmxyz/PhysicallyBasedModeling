...
public:
	...
	struct GraphicsPipelineParams // GraphicsPipeline と同値
	{
		...
		std::string vertexLayoutName;// 実際は Vertex は複数バッファに分割可能
	...
	template<>
	static VertexAttributeLayout::Attributes::AttributeFormat typeConverterFormat<fvec2>()
	{
		return VertexAttributeLayout::Attributes::AttributeFormat::Vec2;
	}
	template<>
	static VertexAttributeLayout::Attributes::AttributeFormat typeConverterFormat<fvec3>()
	{
		return VertexAttributeLayout::Attributes::AttributeFormat::Vec3;
	}
	template<>
	static VertexAttributeLayout::Attributes::AttributeFormat typeConverterFormat<fvec4>()
	{
