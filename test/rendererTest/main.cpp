...
int main()
{
	...
	rendererInitializeParams.vertShaderPath = "ShaderBinary\\test.vert.spv";
	rendererInitializeParams.fragShaderPath = "ShaderBinary\\test.frag.spv";
	...
	graphicsPipelineParams.vertexLayoutName = "struct BasicVertex";
